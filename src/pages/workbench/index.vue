      ...
      <div class="topMenu f ac jb" v-if="project?.id">
        ...
        <div class="rightBtnList f ac">
          <t-tooltip
            ...
            <div
              class="item fc c"
              v-if="menu.type === 'btn' && shouldShowMenu(menu)"
...
const rightBtnList = ref([
  ...
  { type: "btn", path: "/musicAgent", labelKey: "workbench.menu.musicAgent", icon: "i-music", musicOnly: true },
...
function shouldShowMenu(menu: any) {
  if (menu.type !== "btn") return true;
  const pt = project.value?.projectType;
